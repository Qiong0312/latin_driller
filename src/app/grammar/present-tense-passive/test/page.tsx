...
const questions = presentTensePassiveQuiz;

export default function PresentTensePassiveTestPage() {
  ...
  if (scored) {
    return (
      <div className="app-panel">
        <QuizResultsSummary
          resultsHeading={"The present tense passive — Test results"}
          score={score}
          totalQuestions={shuffledQuestions.length}
          quizPath={pathname}
          backHref={"/grammar/present-tense-passive"}
  ...
  return (
    <div className="app-panel">
      <h1 className="text-4xl font-bold text-center mb-4 text-black dark:text-zinc-50">The present tense passive — Quiz</h1>
      <div className="mb-4">
