...
const questions = imperativeQuiz;

export default function ImperativeTestPage() {
  ...
  if (scored) {
    return (
      <div className="app-panel">
        <h1 className="text-4xl font-bold text-center mb-8 text-black dark:text-zinc-50">Imperative — Test results</h1>
  ...
  return (
    <div className="app-panel">
      <h1 className="text-4xl font-bold text-center mb-4 text-black dark:text-zinc-50">Imperative mastery — Quiz</h1>
      <div className="mb-4">
