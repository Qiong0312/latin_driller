...
const questions = demonstrativePronounsIQuiz;

export default function DemonstrativePronounsITestPage() {
    ...
    return (
      <div className="app-panel">
        <h1 className="text-4xl font-bold text-center mb-8 text-black dark:text-zinc-50">
          Demonstrative pronouns I — Test results
        </h1>
        ...
        <div className="text-center mt-8">
          <Link
            href="/grammar/demonstrative-pronouns-i"
          ...
          >
            Back to Demonstrative pronouns I lesson
          </Link>
        </div>
      </div>
    );
