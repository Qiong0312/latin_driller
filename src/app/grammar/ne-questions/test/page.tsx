...
const questions = neQuestionsQuiz;

export default function NeQuestionsTestPage() {
  ...
  return (
    <div className="app-panel">
      <h1 className="text-4xl font-bold text-center mb-4 text-black dark:text-zinc-50">-ne questions mastery — Quiz</h1>
      <div className="mb-4">
