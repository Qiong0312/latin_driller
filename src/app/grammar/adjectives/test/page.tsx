...
const questions = [
  ...
  {
    question: 'In libros bonos habeo, bonos agrees in:',
  ...
  {
    question: 'Peritior can also mean:',
    options: ['Most skilled', 'Somewhat skilled', 'Not skilled', 'Skilled only'],
    correct: 1,
  },
  {
    question: 'Peritissimus can mean:',
    options: ['Very skilled or most skilled', 'Less skilled', 'Not skilled', 'Equal skill'],
    correct: 0,
  },
  {
    question: 'Fill in the blank: Libros ____ habeo. (good books)',
    options: ['boni', 'bonos', 'bona', 'bonum'],
    correct: 1,
  },
  {
    question: 'Fill in the blank: Puella ____ est. (skilled girl)',
    options: ['peritus', 'perita', 'peritam', 'peritos'],
    correct: 1,
  },
  {
    question: 'Fill in the blank: Servum ____ video. (skilled slave)',
    options: ['peritus', 'peritum', 'perita', 'peritos'],
    correct: 1,
  },
  {
    question: 'Fill in the blank: Librum ____ lego. (good book)',
    options: ['boni', 'bonum', 'bonos', 'bona'],
    correct: 1,
  },
  {
    question: 'Fill in the blank: Puellas ____ video. (skilled girls)',
    options: ['peritas', 'peritos', 'perita', 'peritus'],
    correct: 0,
  },
  {
    question: 'Fill in the blank: Vir ____ est. (very skilled man)',
    options: ['peritissimus', 'peritissimos', 'peritissimum', 'peritissima'],
    correct: 0,
  },
  {
    question: 'Fill in the blank: Viros ____ video. (very skilled men)',
    options: ['peritissimus', 'peritissimos', 'peritissima', 'peritissimum'],
    correct: 1,
  },
  {
    question: 'Fill in the blank: Libri ____ sunt. (good books)',
    options: ['bonum', 'bonos', 'boni', 'bonae'],
    correct: 2,
  },
];
