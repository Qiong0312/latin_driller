...
const questions = demonstrativePronounsIVQuiz;

export default function DemonstrativePronounsIVTestPage() {
  ...
  if (scored) {
    return (
      <div className="app-panel">
        <QuizResultsSummary
          resultsHeading="Demonstrative pronouns IV — Test results"
          score={score}
          totalQuestions={shuffledQuestions.length}
          quizPath={pathname}
          backHref="/grammar/demonstrative-pronouns-iv"
  ...
  return (
    <div className="app-panel">
      <h1 className="mb-4 text-center text-4xl font-bold text-black dark:text-zinc-50">
        Demonstrative pronouns IV — Quiz
      </h1>
      <div className="mb-4">
