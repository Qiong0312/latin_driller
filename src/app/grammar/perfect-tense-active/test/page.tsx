...
const questions = perfectTenseActiveQuiz;

export default function PerfectTenseActiveTestPage() {
  ...
  if (scored) {
    return (
      <div className="app-panel">
        <QuizResultsSummary
          resultsHeading={"The perfect tense active — Test results"}
          score={score}
          totalQuestions={shuffledQuestions.length}
          quizPath={pathname}
          backHref={"/grammar/perfect-tense-active"}
  ...
  return (
    <div className="app-panel">
      <h1 className="text-4xl font-bold text-center mb-4 text-black dark:text-zinc-50">The perfect tense active — Quiz</h1>
      <div className="mb-4">
