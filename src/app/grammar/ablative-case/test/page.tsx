...
const questions = grammarAblativeQuiz;

export default function AblativeCaseTestPage() {
  ...
  if (scored) {
    return (
      <div className="app-panel">
        <QuizResultsSummary
          resultsHeading="Ablative Case Test Results"
          score={score}
          totalQuestions={shuffledQuestions.length}
          quizPath={pathname}
          backHref="/grammar/ablative-case"
  ...
  return (
    <div className="app-panel">
      <h1 className="mb-4 text-center text-4xl font-bold text-black dark:text-zinc-50">Ablative Case Test</h1>
      <div className="mb-4">
