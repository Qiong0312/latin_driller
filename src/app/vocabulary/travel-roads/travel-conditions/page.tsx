...
import { TRAVEL_CONDITIONS } from '@/lib/quizBanks/vocabulary/travelRoadsVocab';

export default function TravelConditionsPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🚶 Travel conditions</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TRAVEL_CONDITIONS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/travel-roads/travel-conditions/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/travel-roads/travel-conditions/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/travel-roads/travel-conditions/test" />
        <LessonDoneButton lessonPath="/vocabulary/travel-roads/travel-conditions" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/travel-roads/travel-conditions" />
    </div>
  );
}
