...
import { TRAVEL_PLACES_LOCATIONS } from '@/lib/quizBanks/vocabulary/travelRoadsVocab';

export default function TravelPlacesLocationsPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🌍 Places &amp; locations</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TRAVEL_PLACES_LOCATIONS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/travel-roads/places-locations/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/travel-roads/places-locations/test">
            <button
              type="button"
          ...
          <Link href="/vocabulary/travel-roads">
            <button
              type="button"
            ...
            >
              Back to Travel &amp; Roads
            </button>
          </Link>
        </div>
        <LessonQuizMedalCard quizPath="/vocabulary/travel-roads/places-locations/test" />
        <LessonDoneButton lessonPath="/vocabulary/travel-roads/places-locations" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/travel-roads/places-locations" />
    </div>
  );
}
