...
import { TRAVEL_JOURNEY_MOVEMENT } from '@/lib/quizBanks/vocabulary/travelRoadsVocab';

export default function TravelJourneyMovementPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🧍 Journey &amp; movement</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TRAVEL_JOURNEY_MOVEMENT.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/travel-roads/journey-movement/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/travel-roads/journey-movement/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/travel-roads/journey-movement/test" />
        <LessonDoneButton lessonPath="/vocabulary/travel-roads/journey-movement" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/travel-roads/journey-movement" />
    </div>
  );
}
