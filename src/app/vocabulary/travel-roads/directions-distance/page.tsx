...
import { TRAVEL_DIRECTIONS_DISTANCE } from '@/lib/quizBanks/vocabulary/travelRoadsVocab';

export default function TravelDirectionsDistancePage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TRAVEL_DIRECTIONS_DISTANCE.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/travel-roads/directions-distance/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/travel-roads/directions-distance/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/travel-roads/directions-distance/test" />
        <LessonDoneButton lessonPath="/vocabulary/travel-roads/directions-distance" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/travel-roads/directions-distance" />
    </div>
  );
}
