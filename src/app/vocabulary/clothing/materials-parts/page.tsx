...
import { CLOTHING_MATERIALS_PARTS } from '@/lib/quizBanks/vocabulary/clothingVocab';

export default function ClothingMaterialsPartsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CLOTHING_MATERIALS_PARTS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/clothing/materials-parts/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/clothing/materials-parts/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/clothing/materials-parts/test" />
        <LessonDoneButton lessonPath="/vocabulary/clothing/materials-parts" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/clothing/materials-parts" />
    </div>
  );
}
