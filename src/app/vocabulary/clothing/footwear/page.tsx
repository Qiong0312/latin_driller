...
import { CLOTHING_FOOTWEAR } from '@/lib/quizBanks/vocabulary/clothingVocab';

export default function ClothingFootwearPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">👞 Footwear</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CLOTHING_FOOTWEAR.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/clothing/footwear/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/clothing/footwear/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/clothing/footwear/test" />
        <LessonDoneButton lessonPath="/vocabulary/clothing/footwear" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/clothing/footwear" />
    </div>
  );
}
