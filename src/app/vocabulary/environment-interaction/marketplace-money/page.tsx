...
import { ENV_INTERACTION_MARKETPLACE } from '@/lib/quizBanks/vocabulary/environmentInteractionVocab';

export default function EnvironmentInteractionMarketplaceMoneyPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {ENV_INTERACTION_MARKETPLACE.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/environment-interaction/marketplace-money/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/environment-interaction/marketplace-money/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/environment-interaction/marketplace-money/test" />
        <LessonDoneButton lessonPath="/vocabulary/environment-interaction/marketplace-money" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/environment-interaction/marketplace-money" />
    </div>
  );
}
