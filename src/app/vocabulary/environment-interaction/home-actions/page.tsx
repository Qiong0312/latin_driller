...
import { ENV_INTERACTION_HOME } from '@/lib/quizBanks/vocabulary/environmentInteractionVocab';

export default function EnvironmentInteractionHomeActionsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {ENV_INTERACTION_HOME.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/environment-interaction/home-actions/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/environment-interaction/home-actions/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/environment-interaction/home-actions/test" />
        <LessonDoneButton lessonPath="/vocabulary/environment-interaction/home-actions" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/environment-interaction/home-actions" />
    </div>
  );
}
