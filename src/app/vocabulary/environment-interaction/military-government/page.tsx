...
import { ENV_INTERACTION_MILITARY } from '@/lib/quizBanks/vocabulary/environmentInteractionVocab';

export default function EnvironmentInteractionMilitaryGovernmentPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {ENV_INTERACTION_MILITARY.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/environment-interaction/military-government/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/environment-interaction/military-government/test">
            <button
              type="button"
          ...
          <Link href="/vocabulary/environment-interaction">
            <button
              type="button"
            ...
            >
              Back to Environment &amp; Interaction
            </button>
          </Link>
        </div>
        <LessonQuizMedalCard quizPath="/vocabulary/environment-interaction/military-government/test" />
        <LessonDoneButton lessonPath="/vocabulary/environment-interaction/military-government" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/environment-interaction/military-government" />
    </div>
  );
}
