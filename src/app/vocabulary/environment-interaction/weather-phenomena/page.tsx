...
import { ENV_INTERACTION_WEATHER } from '@/lib/quizBanks/vocabulary/environmentInteractionVocab';

export default function EnvironmentInteractionWeatherPhenomenaPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {ENV_INTERACTION_WEATHER.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/environment-interaction/weather-phenomena/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/environment-interaction/weather-phenomena/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/environment-interaction/weather-phenomena/test" />
        <LessonDoneButton lessonPath="/vocabulary/environment-interaction/weather-phenomena" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/environment-interaction/weather-phenomena" />
    </div>
  );
}
