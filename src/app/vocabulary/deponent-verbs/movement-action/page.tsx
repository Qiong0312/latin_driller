...
import { DEPONENT_MOVEMENT } from '@/lib/quizBanks/vocabulary/deponentVerbsVocab';

export default function DeponentMovementActionPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🧭 Movement &amp; Action</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {DEPONENT_MOVEMENT.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/deponent-verbs/movement-action/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/deponent-verbs/movement-action/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/deponent-verbs/movement-action/test" />
        <LessonDoneButton lessonPath="/vocabulary/deponent-verbs/movement-action" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/deponent-verbs/movement-action" />
    </div>
  );
}
