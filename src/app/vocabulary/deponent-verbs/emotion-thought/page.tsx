...
import { DEPONENT_EMOTION } from '@/lib/quizBanks/vocabulary/deponentVerbsVocab';

export default function DeponentEmotionThoughtPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">💭 Emotion &amp; Thought</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {DEPONENT_EMOTION.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/deponent-verbs/emotion-thought/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/deponent-verbs/emotion-thought/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/deponent-verbs/emotion-thought/test" />
        <LessonDoneButton lessonPath="/vocabulary/deponent-verbs/emotion-thought" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/deponent-verbs/emotion-thought" />
    </div>
  );
}
