...
import { IRREGULAR_VERBS_COMPOUND } from '@/lib/quizBanks/vocabulary/irregularVerbsVocab';
    ...
    <div className="app-panel">
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/irregular-verbs/compound/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/irregular-verbs/compound/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/irregular-verbs/compound/test" />
        <LessonDoneButton lessonPath="/vocabulary/irregular-verbs/compound" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/irregular-verbs/compound" />
    </div>
  );
}
