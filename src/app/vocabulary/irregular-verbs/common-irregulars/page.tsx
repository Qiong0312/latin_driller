...
import { IRREGULAR_VERBS_COMMON } from '@/lib/quizBanks/vocabulary/irregularVerbsVocab';

export default function IrregularVerbsCommonPage() {
  return (
    <div className="app-panel">
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/irregular-verbs/common-irregulars/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/irregular-verbs/common-irregulars/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/irregular-verbs/common-irregulars/test" />
        <LessonDoneButton lessonPath="/vocabulary/irregular-verbs/common-irregulars" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/irregular-verbs/common-irregulars" />
    </div>
  );
}
