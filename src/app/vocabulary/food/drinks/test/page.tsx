...
import { FOOD_DRINKS_QUIZ } from '@/lib/quizBanks/vocabulary/foodCategoryQuestionBank';

const questions = FOOD_DRINKS_QUIZ;
    ...
    return (
      <div className="app-panel">
        ...
        <div className="text-center mt-8">
          <Link href="/vocabulary/food/drinks" className="inline-block px-6 py-3 rounded-lg bg-zinc-200 text-zinc-900 shadow-sm transition hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-100 dark:hover:bg-zinc-600">
            Back to Lesson
          </Link>
        </div>
      </div>
