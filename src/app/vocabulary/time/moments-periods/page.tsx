...
import { TIME_MOMENTS_PERIODS } from '@/lib/quizBanks/vocabulary/timeVocab';

export default function TimeMomentsPeriodsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TIME_MOMENTS_PERIODS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/time/moments-periods/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/time/moments-periods/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/time/moments-periods/test" />
        <LessonDoneButton lessonPath="/vocabulary/time/moments-periods" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/time/moments-periods" />
    </div>
  );
}
