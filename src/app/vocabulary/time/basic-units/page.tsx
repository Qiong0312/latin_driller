...
import { TIME_BASIC_UNITS } from '@/lib/quizBanks/vocabulary/timeVocab';

export default function TimeBasicUnitsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TIME_BASIC_UNITS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/time/basic-units/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/time/basic-units/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/time/basic-units/test" />
        <LessonDoneButton lessonPath="/vocabulary/time/basic-units" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/time/basic-units" />
    </div>
  );
}
