...
import { ROOMS_GENERAL_QUIZ } from '@/lib/quizBanks/vocabulary/roomsCategoryQuestionBank';
    ...
    return (
      <div className="app-panel">
        <h1 className="text-4xl font-bold text-center mb-8 text-black dark:text-zinc-50">
          General House Spaces — Test Results
        </h1>
        ...
        <div className="text-center mt-8">
          <Link href="/vocabulary/rooms/general" className="inline-block px-6 py-3 rounded-lg bg-zinc-200 text-zinc-900 shadow-sm transition hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-100 dark:hover:bg-zinc-600">
            Back to Lesson
          </Link>
        </div>
      </div>
