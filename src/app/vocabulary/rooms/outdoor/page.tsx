...
export default function RoomsOutdoor() {
  return (
    <div className="app-panel">
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/rooms/outdoor/flashcards">
          ...
          <Link href="/vocabulary/rooms/outdoor/test">
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/rooms/outdoor/test" />
        <LessonDoneButton lessonPath="/vocabulary/rooms/outdoor" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/rooms/outdoor" />
    </div>
  );
}
