    ...
    <div className="w-full max-w-4xl p-8 bg-white dark:bg-black shadow-lg rounded-lg mx-4">
      ...
      <div className="text-lg leading-relaxed text-zinc-800 dark:text-zinc-200 space-y-6">
        ...
        <div className="space-y-4">
          <Link href="/vocabulary/animals/common">
          ...
          <Link href="/vocabulary/animals/wild">
          ...
          <Link href="/vocabulary/animals/birds">
          ...
          <Link href="/vocabulary/animals/sea">
          ...
          <Link href="/vocabulary/animals/small">
