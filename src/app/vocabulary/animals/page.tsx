  ...
  return (
    <div className="app-panel">
      ...
      <p className="mb-8 text-center text-lg text-zinc-600 dark:text-zinc-300">
        Beasts of land and sky, swimmers, crawlers, and small creatures.
      </p>
      <div className="space-y-6 text-lg leading-relaxed text-zinc-800 dark:text-zinc-200">
        ...
        <div className="space-y-4">
          ...
          <VocabularySubLessonCard
            ...
            cardClassName="cursor-pointer rounded-lg bg-yellow-50 p-4 transition hover:bg-yellow-100 dark:bg-yellow-950/40 dark:hover:bg-yellow-900/50"
          >
