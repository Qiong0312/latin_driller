    ...
    <div className="w-full max-w-4xl p-8 bg-white dark:bg-black shadow-lg rounded-lg mx-4">
      ...
      <div className="mb-5 flex justify-center">
        ...
        >
          ...
          <span
            className="my-1.5 w-px shrink-0 bg-emerald-200 dark:bg-emerald-700"
            aria-hidden
          />
          <button
            type="button"
      ...
      <div className="mb-5">
        <div className="w-full rounded-full h-2 bg-zinc-100 dark:bg-zinc-800">
          <div
            className="bg-emerald-300 h-2 rounded-full transition-all dark:bg-emerald-600"
