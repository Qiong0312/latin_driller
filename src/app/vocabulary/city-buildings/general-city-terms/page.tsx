...
import { CITY_GENERAL_TERMS } from '@/lib/quizBanks/vocabulary/cityBuildingsVocab';

export default function CityGeneralTermsPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🌆 General city terms</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CITY_GENERAL_TERMS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/city-buildings/general-city-terms/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/city-buildings/general-city-terms/test">
            <button
              type="button"
          ...
          <Link href="/vocabulary/city-buildings">
            <button
              type="button"
            ...
            >
              Back to City &amp; Buildings
            </button>
          </Link>
        </div>
        <LessonQuizMedalCard quizPath="/vocabulary/city-buildings/general-city-terms/test" />
        <LessonDoneButton lessonPath="/vocabulary/city-buildings/general-city-terms" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/city-buildings/general-city-terms" />
    </div>
  );
}
