...
import { CITY_BUILDINGS_STRUCTURES } from '@/lib/quizBanks/vocabulary/cityBuildingsVocab';

export default function CityBuildingsStructuresPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CITY_BUILDINGS_STRUCTURES.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/city-buildings/buildings-structures/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/city-buildings/buildings-structures/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/city-buildings/buildings-structures/test" />
        <LessonDoneButton lessonPath="/vocabulary/city-buildings/buildings-structures" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/city-buildings/buildings-structures" />
    </div>
  );
}
