...
import { CITY_BUILDING_PARTS } from '@/lib/quizBanks/vocabulary/cityBuildingsVocab';

export default function CityBuildingPartsPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🚪 Parts of buildings</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CITY_BUILDING_PARTS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/city-buildings/building-parts/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/city-buildings/building-parts/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/city-buildings/building-parts/test" />
        <LessonDoneButton lessonPath="/vocabulary/city-buildings/building-parts" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/city-buildings/building-parts" />
    </div>
  );
}
