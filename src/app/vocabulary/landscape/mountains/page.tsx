...
export default function LandscapeMountainsPage() {
  return (
    <div className="app-panel">
      <h1 className="text-4xl font-bold text-center mb-8 text-black dark:text-zinc-50">🏔️ Mountains &amp; landforms</h1>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/landscape/mountains/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/landscape/mountains/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/landscape/mountains/test" />
        <LessonDoneButton lessonPath="/vocabulary/landscape/mountains" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/landscape/mountains" />
    </div>
  );
}
