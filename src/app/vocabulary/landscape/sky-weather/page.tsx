...
export default function LandscapeSkyWeatherPage() {
  return (
    <div className="w-full max-w-4xl p-8 bg-white dark:bg-black shadow-lg rounded-lg mx-4">
      <h1 className="text-4xl font-bold text-center mb-8 text-black dark:text-zinc-50">☀️ Sky &amp; weather</h1>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/landscape/sky-weather/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/landscape/sky-weather/test">
            <button
              type="button"
