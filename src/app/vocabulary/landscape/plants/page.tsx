...
export default function LandscapePlantsPage() {
  return (
    <div className="app-panel">
      <h1 className="text-4xl font-bold text-center mb-8 text-black dark:text-zinc-50">🌳 Plants &amp; nature</h1>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/landscape/plants/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/landscape/plants/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/landscape/plants/test" />
        <LessonDoneButton lessonPath="/vocabulary/landscape/plants" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/landscape/plants" />
    </div>
  );
}
