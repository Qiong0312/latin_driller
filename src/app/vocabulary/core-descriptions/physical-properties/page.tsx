...
import { CORE_DESCRIPTIONS_PHYSICAL } from '@/lib/quizBanks/vocabulary/coreDescriptionsVocab';

export default function CoreDescriptionsPhysicalPropertiesPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CORE_DESCRIPTIONS_PHYSICAL.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/core-descriptions/physical-properties/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-descriptions/physical-properties/test">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-descriptions">
            <button
              type="button"
            ...
            >
              Back to Core Descriptions
            </button>
          </Link>
        </div>
        <LessonQuizMedalCard quizPath="/vocabulary/core-descriptions/physical-properties/test" />
        <LessonDoneButton lessonPath="/vocabulary/core-descriptions/physical-properties" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/core-descriptions/physical-properties" />
    </div>
  );
}
