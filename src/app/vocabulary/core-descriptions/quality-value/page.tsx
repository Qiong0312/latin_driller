...
import { CORE_DESCRIPTIONS_QUALITY } from '@/lib/quizBanks/vocabulary/coreDescriptionsVocab';

export default function CoreDescriptionsQualityValuePage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CORE_DESCRIPTIONS_QUALITY.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/core-descriptions/quality-value/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-descriptions/quality-value/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/core-descriptions/quality-value/test" />
        <LessonDoneButton lessonPath="/vocabulary/core-descriptions/quality-value" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/core-descriptions/quality-value" />
    </div>
  );
}
