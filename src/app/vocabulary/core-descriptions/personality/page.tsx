...
import { CORE_DESCRIPTIONS_PERSONALITY } from '@/lib/quizBanks/vocabulary/coreDescriptionsVocab';

export default function CoreDescriptionsPersonalityPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CORE_DESCRIPTIONS_PERSONALITY.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/core-descriptions/personality/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-descriptions/personality/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/core-descriptions/personality/test" />
        <LessonDoneButton lessonPath="/vocabulary/core-descriptions/personality" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/core-descriptions/personality" />
    </div>
  );
}
