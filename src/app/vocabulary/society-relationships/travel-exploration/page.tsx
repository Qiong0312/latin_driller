...
import { SOCIETY_TRAVEL } from '@/lib/quizBanks/vocabulary/societyRelationshipsVocab';

export default function SocietyTravelExplorationPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SOCIETY_TRAVEL.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/society-relationships/travel-exploration/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/society-relationships/travel-exploration/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/society-relationships/travel-exploration/test" />
        <LessonDoneButton lessonPath="/vocabulary/society-relationships/travel-exploration" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/society-relationships/travel-exploration" />
    </div>
  );
}
