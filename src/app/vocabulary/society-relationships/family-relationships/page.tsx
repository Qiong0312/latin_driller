...
import { SOCIETY_FAMILY } from '@/lib/quizBanks/vocabulary/societyRelationshipsVocab';

export default function SocietyFamilyRelationshipsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SOCIETY_FAMILY.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/society-relationships/family-relationships/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/society-relationships/family-relationships/test">
            <button
              type="button"
      ...
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/society-relationships/family-relationships" />
    </div>
  );
}
