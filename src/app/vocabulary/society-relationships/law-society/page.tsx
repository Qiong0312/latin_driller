...
import { SOCIETY_LAW } from '@/lib/quizBanks/vocabulary/societyRelationshipsVocab';

export default function SocietyLawSocietyPage() {
  return (
    <div className="app-panel">
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/society-relationships/law-society/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/society-relationships/law-society/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/society-relationships/law-society/test" />
        <LessonDoneButton lessonPath="/vocabulary/society-relationships/law-society" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/society-relationships/law-society" />
    </div>
  );
}
