...
import { SOCIETY_RELIGION } from '@/lib/quizBanks/vocabulary/societyRelationshipsVocab';

export default function SocietyReligionRitualPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SOCIETY_RELIGION.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/society-relationships/religion-ritual/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/society-relationships/religion-ritual/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/society-relationships/religion-ritual/test" />
        <LessonDoneButton lessonPath="/vocabulary/society-relationships/religion-ritual" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/society-relationships/religion-ritual" />
    </div>
  );
}
