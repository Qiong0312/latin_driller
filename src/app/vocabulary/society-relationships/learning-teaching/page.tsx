...
import { SOCIETY_LEARNING } from '@/lib/quizBanks/vocabulary/societyRelationshipsVocab';

export default function SocietyLearningTeachingPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SOCIETY_LEARNING.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/society-relationships/learning-teaching/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/society-relationships/learning-teaching/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/society-relationships/learning-teaching/test" />
        <LessonDoneButton lessonPath="/vocabulary/society-relationships/learning-teaching" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/society-relationships/learning-teaching" />
    </div>
  );
}
