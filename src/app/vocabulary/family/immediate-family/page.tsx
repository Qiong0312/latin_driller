...
export default function FamilyImmediatePage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">👪 Immediate Family</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {FAMILY_IMMEDIATE.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/family/immediate-family/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/family/immediate-family/test">
            <button
              type="button"
