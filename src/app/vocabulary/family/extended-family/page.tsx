...
import { FAMILY_EXTENDED } from '@/lib/quizBanks/vocabulary/familyVocab';

export default function FamilyExtendedPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">👴 Extended Family</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {FAMILY_EXTENDED.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/family/extended-family/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/family/extended-family/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/family/extended-family/test" />
        <LessonDoneButton lessonPath="/vocabulary/family/extended-family" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/family/extended-family" />
    </div>
  );
}
