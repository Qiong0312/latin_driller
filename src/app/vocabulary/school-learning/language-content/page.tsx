...
import { SCHOOL_LANGUAGE_CONTENT } from '@/lib/quizBanks/vocabulary/schoolLearningVocab';

export default function SchoolLanguageContentPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SCHOOL_LANGUAGE_CONTENT.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/school-learning/language-content/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/school-learning/language-content/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/school-learning/language-content/test" />
        <LessonDoneButton lessonPath="/vocabulary/school-learning/language-content" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/school-learning/language-content" />
    </div>
  );
}
