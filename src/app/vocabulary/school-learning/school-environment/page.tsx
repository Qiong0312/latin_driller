...
import { SCHOOL_ENVIRONMENT } from '@/lib/quizBanks/vocabulary/schoolLearningVocab';

export default function SchoolEnvironmentPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🏫 School environment</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SCHOOL_ENVIRONMENT.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/school-learning/school-environment/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/school-learning/school-environment/test">
            <button
              type="button"
          ...
          <Link href="/vocabulary/school-learning">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/school-learning/school-environment/test" />
        <LessonDoneButton lessonPath="/vocabulary/school-learning/school-environment" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/school-learning/school-environment" />
    </div>
  );
}
