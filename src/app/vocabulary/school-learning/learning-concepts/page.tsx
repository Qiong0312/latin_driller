...
import { SCHOOL_LEARNING_CONCEPTS } from '@/lib/quizBanks/vocabulary/schoolLearningVocab';

export default function SchoolLearningConceptsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SCHOOL_LEARNING_CONCEPTS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/school-learning/learning-concepts/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/school-learning/learning-concepts/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/school-learning/learning-concepts/test" />
        <LessonDoneButton lessonPath="/vocabulary/school-learning/learning-concepts" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/school-learning/learning-concepts" />
    </div>
  );
}
