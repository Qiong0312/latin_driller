...
import { SCHOOL_STUDY_MATERIALS } from '@/lib/quizBanks/vocabulary/schoolLearningVocab';

export default function SchoolStudyMaterialsPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {SCHOOL_STUDY_MATERIALS.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/school-learning/study-materials/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/school-learning/study-materials/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/school-learning/study-materials/test" />
        <LessonDoneButton lessonPath="/vocabulary/school-learning/study-materials" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/school-learning/study-materials" />
    </div>
  );
}
