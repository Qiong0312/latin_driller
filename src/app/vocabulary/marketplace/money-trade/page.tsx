...
import { MARKETPLACE_MONEY_TRADE } from "@/lib/vocabulary/marketplaceVocab";
  ...
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {MARKETPLACE_MONEY_TRADE.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/marketplace/money-trade/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/marketplace/money-trade/test">
            <button
              type="button"
