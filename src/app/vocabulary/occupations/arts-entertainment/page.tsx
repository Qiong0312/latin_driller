  ...
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {OCCUPATIONS_ARTS_ENTERTAINMENT.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/occupations/arts-entertainment/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/occupations/arts-entertainment/test">
            <button
              type="button"
