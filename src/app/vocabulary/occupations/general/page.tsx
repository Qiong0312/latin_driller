...
import { OCCUPATIONS_GENERAL } from '@/lib/quizBanks/vocabulary/occupationsVocab';

export default function OccupationsGeneralPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🏛️ General occupations</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {OCCUPATIONS_GENERAL.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/occupations/general/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/occupations/general/test">
            <button
              type="button"
          ...
          <Link href="/vocabulary/occupations">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/occupations/general/test" />
        <LessonDoneButton lessonPath="/vocabulary/occupations/general" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/occupations/general" />
    </div>
  );
}
