...
export default function OccupationsMilitaryGovernmentPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">⚔️ Military &amp; government</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {OCCUPATIONS_MILITARY_GOVERNMENT.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/occupations/military-government/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/occupations/military-government/test">
            <button
              type="button"
