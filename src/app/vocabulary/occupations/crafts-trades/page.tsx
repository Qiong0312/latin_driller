...
export default function OccupationsCraftsTradesPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">🛠️ Crafts &amp; trades</h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {OCCUPATIONS_CRAFTS_TRADES.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/occupations/crafts-trades/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/occupations/crafts-trades/test">
            <button
              type="button"
