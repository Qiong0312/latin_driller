...
import { TOOLS_CUTTING_WORK } from '@/lib/quizBanks/vocabulary/toolsObjectsVocab';

export default function ToolsCuttingWorkPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {TOOLS_CUTTING_WORK.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/tools-objects/cutting-work-tools/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/tools-objects/cutting-work-tools/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/tools-objects/cutting-work-tools/test" />
        <LessonDoneButton lessonPath="/vocabulary/tools-objects/cutting-work-tools" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/tools-objects/cutting-work-tools" />
    </div>
  );
}
