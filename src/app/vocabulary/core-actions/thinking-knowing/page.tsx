...
import { CORE_ACTIONS_THINK } from '@/lib/quizBanks/vocabulary/coreActionsVocab';

export default function CoreActionsThinkingPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CORE_ACTIONS_THINK.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/core-actions/thinking-knowing/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-actions/thinking-knowing/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/core-actions/thinking-knowing/test" />
        <LessonDoneButton lessonPath="/vocabulary/core-actions/thinking-knowing" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/core-actions/thinking-knowing" />
    </div>
  );
}
