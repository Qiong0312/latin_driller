...
import { CORE_ACTIONS_COMM } from '@/lib/quizBanks/vocabulary/coreActionsVocab';

export default function CoreActionsCommunicationPage() {
  return (
    <div className="app-panel">
      <h1 className="mb-8 text-center text-4xl font-bold text-black dark:text-zinc-50">
        🗣️ Communication (Cōnloquium)
      </h1>
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CORE_ACTIONS_COMM.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/core-actions/communication/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-actions/communication/test">
            <button
              type="button"
      ...
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/core-actions/communication" />
    </div>
  );
}
