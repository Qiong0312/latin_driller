...
import { CORE_ACTIONS_DAILY } from '@/lib/quizBanks/vocabulary/coreActionsVocab';

export default function CoreActionsDailyPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {CORE_ACTIONS_DAILY.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/core-actions/daily-actions/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/core-actions/daily-actions/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/core-actions/daily-actions/test" />
        <LessonDoneButton lessonPath="/vocabulary/core-actions/daily-actions" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/core-actions/daily-actions" />
    </div>
  );
}
