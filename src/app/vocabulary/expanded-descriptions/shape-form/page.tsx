...
import { EXPANDED_DESCRIPTIONS_SHAPE } from '@/lib/quizBanks/vocabulary/expandedDescriptionsVocab';

export default function ExpandedDescriptionsShapeFormPage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {EXPANDED_DESCRIPTIONS_SHAPE.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/expanded-descriptions/shape-form/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/expanded-descriptions/shape-form/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/expanded-descriptions/shape-form/test" />
        <LessonDoneButton lessonPath="/vocabulary/expanded-descriptions/shape-form" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/expanded-descriptions/shape-form" />
    </div>
  );
}
