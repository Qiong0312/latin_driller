...
import { EXPANDED_DESCRIPTIONS_SENSORY } from '@/lib/quizBanks/vocabulary/expandedDescriptionsVocab';

export default function ExpandedDescriptionsSensoryAppearancePage() {
  return (
    <div className="app-panel">
      ...
      <ul className="list-inside list-disc space-y-2 pl-4 text-lg text-zinc-800 dark:text-zinc-200">
        {EXPANDED_DESCRIPTIONS_SENSORY.map(({ latin, english }) => (
          <li key={latin}>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/vocabulary/expanded-descriptions/sensory-appearance/flashcards">
            <button
              type="button"
          ...
          <Link href="/vocabulary/expanded-descriptions/sensory-appearance/test">
            <button
              type="button"
        ...
        <LessonQuizMedalCard quizPath="/vocabulary/expanded-descriptions/sensory-appearance/test" />
        <LessonDoneButton lessonPath="/vocabulary/expanded-descriptions/sensory-appearance" />
      </div>
      <VocabularyNavFooter variant="subLesson" lessonPath="/vocabulary/expanded-descriptions/sensory-appearance" />
    </div>
  );
}
