...
export const VOCABULARY_CATEGORY_NAV = [
  ...
  { href: '/vocabulary/travel-roads', label: 'Travel & Roads' },
  { href: '/vocabulary/city-buildings', label: 'City & Buildings' },
  { href: '/vocabulary/clothing', label: 'Clothing' },
  { href: '/vocabulary/tools-objects', label: 'Tools & Objects' },
